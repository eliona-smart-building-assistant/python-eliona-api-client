...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Data']:
            return Data

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['Data'], typing.List['Data']],
...
class GetDataTrends(BaseApi):
    ...
    def get_data_trends(
        ...
        return self._get_data_trends_oapg(
