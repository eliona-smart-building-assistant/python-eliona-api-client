...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AssetType']:
            return AssetType

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['AssetType'], typing.List['AssetType']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'AssetType':
...
class GetAssetTypes(BaseApi):
    ...
    def get_asset_types(
        ...
        return self._get_asset_types_oapg(
