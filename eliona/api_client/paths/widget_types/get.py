...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['WidgetType']:
            return WidgetType

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['WidgetType'], typing.List['WidgetType']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'WidgetType':
...
class GetWidgetTypes(BaseApi):
    ...
    def get_widget_types(
        ...
        return self._get_widget_types_oapg(
