...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'asset-id': typing.Union[AssetIdSchema, decimal.Decimal, int, ],
    }
)
...
request_body_asset = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _put_asset_by_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_asset.serialize(body, content_type)
...
class PutAssetById(BaseApi):
    ...
    def put_asset_by_id(
        ...
        return self._put_asset_by_id_oapg(
            body=body,
