...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AlarmRule']:
            return AlarmRule

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['AlarmRule'], typing.List['AlarmRule']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'AlarmRule':
...
class GetAlarmRules(BaseApi):
    ...
    def get_alarm_rules(
        ...
        return self._get_alarm_rules_oapg(
