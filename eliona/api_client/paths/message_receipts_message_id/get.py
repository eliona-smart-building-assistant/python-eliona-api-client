...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'message-id': typing.Union[MessageIdSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = MessageReceipt
...
class BaseApi(api_client.Api):
    ...
    def _get_message_receipt_by_id_oapg(
        self: api_client.Api,
...
class GetMessageReceiptById(BaseApi):
    ...
    def get_message_receipt_by_id(
        ...
        return self._get_message_receipt_by_id_oapg(
