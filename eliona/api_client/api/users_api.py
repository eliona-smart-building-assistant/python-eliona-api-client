...
class UsersApi(object):
    ...
    def get_user_by_id(
        ...
        **kwargs
        ...
        """Information about an user  # noqa: E501

        Gets information about an user.  # noqa: E501
    ...
    def get_users(
        ...
        **kwargs
        ...
        """Information about users  # noqa: E501
    ...
    def put_user(
        ...
        **kwargs
        ...
        """Create or update an user  # noqa: E501

        Creates an user if no user exists or update it if already exists. Uses the email address for updating.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_user(user, async_req=True)
        >>> result = thread.get()
