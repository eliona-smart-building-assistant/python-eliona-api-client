...
class TagsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_tag_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (Tag,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/tags/{tag-name}',
                'operation_id': 'get_tag_by_name',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_tag_by_name(
        ...
        **kwargs
        ...
        """Information about a tag  # noqa: E501

        Gets information about a tag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_tag_by_name(tag_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['tag_name'] = \
            tag_name
        return self.get_tag_by_name_endpoint.call_with_http_info(**kwargs)

    def get_tags(
        self,
        **kwargs
    ):
        """Information about tags  # noqa: E501
    ...
    def put_tag(
        ...
        **kwargs
        ...
        Creates a tag if no tag exists or update it if already exists. Uses name for updating.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_tag(tag, async_req=True)
        >>> result = thread.get()
