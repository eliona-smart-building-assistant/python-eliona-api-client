...
class WidgetsTypesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.put_widget_type_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (WidgetType,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/widget-types/{widget-type-name}',
                'operation_id': 'put_widget_type_by_name',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def post_widget_type(
        ...
        **kwargs
        ...
        """Create a widget type  # noqa: E501
    ...
    def put_widget_type(
        ...
        **kwargs
        ...
        Create a new widget type or update it if already exists. Uses the unique widget type name for updating.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def put_widget_type_by_name(
        ...
        **kwargs
        ...
        """Update a widget type  # noqa: E501

        Update a widget type.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_widget_type_by_name(widget_type_name, widget_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['widget_type'] = \
            widget_type
        return self.put_widget_type_by_name_endpoint.call_with_http_info(**kwargs)
