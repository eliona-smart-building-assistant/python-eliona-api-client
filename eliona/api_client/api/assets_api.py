...
class AssetsApi(object):
    ...
    def put_asset(
        ...
        **kwargs
        ...
        Creates an asset if no asset exists or update it if already exists. Uses the unique combination of project id and global asset id for updating.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
