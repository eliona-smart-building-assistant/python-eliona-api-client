...
class AssetTypesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_asset_type_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth'
                ...
                'operation_id': 'delete_asset_type',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def delete_asset_type(
        ...
        **kwargs
        ...
        >>> thread = api.delete_asset_type(asset_type_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['asset_type_name'] = \
            asset_type_name
        return self.delete_asset_type_endpoint.call_with_http_info(**kwargs)
