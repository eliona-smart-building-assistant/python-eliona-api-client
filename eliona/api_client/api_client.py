...
from eliona.api_client import rest
from eliona.api_client.configuration import Configuration
from eliona.api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from eliona.api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_agent_by_class_and_id  # this is an instance of the class Endpoint
        api_instance.get_agent_by_class_and_id()  # this invokes api_instance.get_agent_by_class_and_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_agent_by_class_and_id.callable or self.callable in this class
