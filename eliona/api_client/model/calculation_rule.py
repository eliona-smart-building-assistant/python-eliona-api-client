...
class CalculationRule(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'filter': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset_id, subtype, attribute, *args, **kwargs):  # noqa: E501
        """CalculationRule - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            virtual (bool, none_type): Is the calculation attribute virtual or not. [optional]  # noqa: E501
            formula (str, none_type): calculation rule to calculate the value for the attribute. [optional]  # noqa: E501
            unit (str, none_type): Physical unit of calculated data. [optional]  # noqa: E501
            filter ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Filter definition for calculation rule. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset_id, subtype, attribute, *args, **kwargs):  # noqa: E501
        """CalculationRule - a model defined in OpenAPI
