...
class Message(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["recipients", "content", "sender", "copyRecipients", "blindCopyRecipients", "subject", "attachments", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["recipients", "content", "sender", "copyRecipients", "blindCopyRecipients", "subject", "attachments", ], str]):
