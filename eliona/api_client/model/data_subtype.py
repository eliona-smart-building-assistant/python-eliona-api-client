...
class DataSubtype(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Type of asset data. if omitted defaults to "input", must be one of ["input", "info", "status", "output", "property", ]  # noqa: E501

        Keyword Args:
            value (str): Type of asset data. if omitted defaults to "input", must be one of ["input", "info", "status", "output", "property", ]  # noqa: E501
