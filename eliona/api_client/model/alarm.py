...
class Alarm(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset_id, subtype, priority, timestamp, occurrences, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset_id, subtype, priority, timestamp, occurrences, *args, **kwargs):  # noqa: E501
        """Alarm - a model defined in OpenAPI
