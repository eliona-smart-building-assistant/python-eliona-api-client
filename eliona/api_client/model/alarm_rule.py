...
class AlarmRule(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'check_type': (str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, asset_id, subtype, attribute, priority, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            params ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Parameter for aggregated alarms. [optional]  # noqa: E501
            ...
            check_type (str, none_type): Check type. [optional]  # noqa: E501
