...
class App(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Delivers the apps metadata to handle it in the app store. [optional]  # noqa: E501
            version (str, none_type): the apps version. [optional]  # noqa: E501
        """
