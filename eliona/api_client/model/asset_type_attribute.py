...
class AssetTypeAttribute(ModelNormal):
    ...
    def _from_openapi_data(cls, name, subtype, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            aggregation_mode (str, none_type): Deprecated: Use the 'GET /data-trend-aggregated' endpoint to retrieve aggregated data for periodic rasters without defining aggregations. Aggregation calculation mode. . [optional]  # noqa: E501
            ...
            formula (str, none_type): calculation rule to calculate the value for this attribute. [optional]  # noqa: E501
            scale (float, none_type): value scale. [optional]  # noqa: E501
            zero (float, none_type): value scale. [optional]  # noqa: E501
            map ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}], none_type): list of mapping between value and custom text. [optional]  # noqa: E501
