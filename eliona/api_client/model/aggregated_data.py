...
class AggregatedData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, asset_id, subtype, raster, *args, **kwargs):  # noqa: E501
        """AggregatedData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, asset_id, subtype, raster, *args, **kwargs):  # noqa: E501
        """AggregatedData - a model defined in OpenAPI
