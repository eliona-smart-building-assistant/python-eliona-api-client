...
class DataTrendAggregated(ModelNormal):
    ...
    def _from_openapi_data(cls, asset_id, *args, **kwargs):  # noqa: E501
        """DataTrendAggregated - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            timestamp (datetime, none_type): Timestamp of this aggregated data set. The timestamp when the timeslot based on raster starts.. [optional]  # noqa: E501
