...
class AssetIdentifyBy(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AssetIdentifyBy - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["resourceId", "deviceId", "id", "gai-projId", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["resourceId", "deviceId", "id", "gai-projId", ]  # noqa: E501
