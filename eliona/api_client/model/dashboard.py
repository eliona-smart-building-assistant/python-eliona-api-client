...
class Dashboard(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'widgets': ([Widget], none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, project_id, user_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            widgets ([Widget], none_type): List of widgets on this dashboard (order matches the order of widgets on the dashboard). [optional]  # noqa: E501
            public (bool, none_type): Is the dashboard public and not bound to a dedicated user. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, project_id, user_id, *args, **kwargs):  # noqa: E501
        """Dashboard - a model defined in OpenAPI
