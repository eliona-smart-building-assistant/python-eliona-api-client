...
class User(ModelNormal):
    ...
    def _from_openapi_data(cls, email, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str, none_type): The internal ID of user. [optional]  # noqa: E501
            firstname (str, none_type): The user's firstname. [optional]  # noqa: E501
            lastname (str, none_type): The user's lastname. [optional]  # noqa: E501
        """
