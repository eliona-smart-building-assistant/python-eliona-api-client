...
class AlarmPriority(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (int): The priority of the alarm. The lower this value the higher the priority.., must be one of [1, 2, 3, 10, ]  # noqa: E501

        Keyword Args:
            value (int): The priority of the alarm. The lower this value the higher the priority.., must be one of [1, 2, 3, 10, ]  # noqa: E501
