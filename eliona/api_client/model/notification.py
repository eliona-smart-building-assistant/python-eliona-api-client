...
class Notification(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, message, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            project_id (str, none_type): ID of the project the notification should appear. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, message, *args, **kwargs):  # noqa: E501
        """Notification - a model defined in OpenAPI
