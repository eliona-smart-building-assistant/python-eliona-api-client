...
from io.eliona.api-client import rest
from io.eliona.api-client.configuration import Configuration
from io.eliona.api-client.exceptions import ApiTypeError, ApiValueError, ApiException
from io.eliona.api-client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AppApi()
        api_instance.apply_patch_by_name  # this is an instance of the class Endpoint
        api_instance.apply_patch_by_name()  # this invokes api_instance.apply_patch_by_name.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.apply_patch_by_name.callable or self.callable in this class
