...
class Heap(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset_id, subtype, data, *args, **kwargs):  # noqa: E501
        """Heap - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset_id, subtype, data, *args, **kwargs):  # noqa: E501
        """Heap - a model defined in OpenAPI
