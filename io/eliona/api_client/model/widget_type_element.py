...
class WidgetTypeElement(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, category, description, *args, **kwargs):  # noqa: E501
        """WidgetTypeElement - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, category, description, *args, **kwargs):  # noqa: E501
        """WidgetTypeElement - a model defined in OpenAPI
