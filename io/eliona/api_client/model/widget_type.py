...
def lazy_import():
    ...
    globals()['WidgetTypeElement'] = WidgetTypeElement
...
class WidgetType(ModelNormal):
    ...
    attribute_map = {
        ...
        'with_timespan': 'withTimespan',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, translation, elements, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            custom (bool): Is this a customer created type or not. defaults to True  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, translation, elements, *args, **kwargs):  # noqa: E501
        """WidgetType - a model defined in OpenAPI
